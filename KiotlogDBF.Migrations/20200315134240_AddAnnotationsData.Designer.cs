...
namespace KiotlogDBF.Migrations
{
    ...
    [Migration("20200315134240_AddAnnotationsData")]
    partial class AddAnnotationsData
    {
            ...
            modelBuilder.Entity("KiotlogDBF.Models.Annotations", b =>
                {
                    ...
                    b.Property<JObject>("Data")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasConversion(new ValueConverter<JObject, string>(v => default(string), v => default(JObject)))
                        .HasColumnName("data")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("KiotlogDBF.Models.Annotations", b =>
                {
                    b.HasOne("KiotlogDBF.Models.Devices", "Device")
                        ...
                        .HasConstraintName("annotations_device_id_fkey")
